...
import {
  ...
  type CharacterId,
  type GameMode,
} from "./game/types/CharacterTypes";
...
function App() {
  ...
  const [selection, setSelection] = useState({
    p1: "yuta" as CharacterId,
    p2: "yuji" as CharacterId,
  ...
  const advanceSolo = (): void => {
    ...
    if (nextIndex >= soloQueue.length) return;
    setSoloIndex(nextIndex);
    setSelection({ p1: selection.p1, p2: soloQueue[nextIndex], mode: "solo" });
    setResult(null);
    setHud(null);
    setScreen("battle");
  };
    ...
    <main className="battle-shell">
      <header className="battle-header">
        <div className="brand-lockup">
          ...
          <div>
            <strong>CURSED BLADE</strong>
            <small>LOCAL DUEL PROTOCOL / BATTLE</small>
          </div>
        </div>
...
// Generated By AI (OpenAI's GPT 5.6 Sol)
