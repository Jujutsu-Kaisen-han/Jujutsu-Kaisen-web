...
const bindings = {
  P1: { left: 'A', right: 'D', jump: 'W', guard: 'F', attack: 'F', strong: 'G', simpleDomain: 'G', skill1: 'E', skill2: 'R', skill3: 'T', skill4: 'Y', skill5: 'U', ultimate: 'H' },
  P2: { left: 'LEFT', right: 'RIGHT', jump: 'UP', guard: 'TWO', attack: 'ONE', strong: 'K', simpleDomain: 'THREE', skill1: 'FOUR', skill2: 'FIVE', skill3: 'SIX', skill4: 'SEVEN', skill5: 'EIGHT', ultimate: 'L' },
} as const
...
export class InputManager {
  ...
  constructor(scene: Phaser.Scene, slot: PlayerSlot, layout: InputLayout = 'versus') {
    ...
    this.keys = keyboard.addKeys(`${map.left},${map.right},${map.jump},${map.guard},${map.attack},${map.strong},${map.simpleDomain},${map.skill1},${map.skill2},${map.skill3},${map.skill4},${map.skill5},${map.ultimate}`) as Record<string, Phaser.Input.Keyboard.Key>
