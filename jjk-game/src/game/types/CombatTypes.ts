...
export interface FighterHudState { name: string; hp: number; maxHp: number; energy: number; maxEnergy: number; ultimate: number; ultimateReady: boolean; domainActive: boolean; simpleDomainActive: boolean; fullManifestActive: boolean; guard: boolean; combo: number }
