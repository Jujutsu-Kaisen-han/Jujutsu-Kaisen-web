...
export class YutaSkillSystem {
  ...
  reverseTechnique(owner: BaseCharacter): boolean { if (owner.definition.id !== 'yuta' || !owner.spendFixedEnergy(30)) return false; owner.heal(28); this.combat.healEffect(owner); return true }
